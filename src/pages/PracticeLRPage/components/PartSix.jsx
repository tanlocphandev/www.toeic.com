                ...
                explains: [
                    {
                        ...
                        question: "<p>Tạm dịch/Mở rộng</p><p> Bạn muốn sử dụng xe đạp để khám phá khu thắng cảnh Lakeview Corridor? Tàu của chúng tôi có trang thiết bị các bạn cần để vận chuyển xe đạp một cách an toàn.</p>",
                        answerA: "A. Cổ phần",
                ...
                <div className="flex justify-between flex-col w-[80%] mr-2 ">
                    {options.map((option, index) => (
                        <div className="w-full rounded-lg border mb-3" key={index}>
                            ...
                            <p className="bg-gray-500 text-white px-1 rounded w-[250px] mt-3 ml-3">[Part 6] Hoàn thành đoạn văn</p>

                            <div className="flex">
                                <div className="flex flex-col w-[62%] px-3 py-4 bg-[#cfe2ff] rounded-lg m-3 h-[650px] overflow-y-auto">
                                    <div className='text-justify' dangerouslySetInnerHTML={{ __html: option.question }} />
